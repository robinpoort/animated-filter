...
(function (root, factory) {
    ...
    var Animation = function (options) {
         ...
         * do something
         */
        publicAPIs.animateFilter = function (options) {
            ...
            document.addEventListener("click", function(event) {
                ...
                // Set active item
                event.target.parentNode.parentNode.querySelector('.is-active').classList.remove('is-active');
        ...
        publicAPIs.init = function (options) {
            ...
            //
            publicAPIs.animateFilter(options);
